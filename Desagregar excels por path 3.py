...
path = r'G:\2.DELEGADAS\UNCOPI\RESPUESTAS RUNTt\Información respuesta\SOLRUNT176\SOLRUNT176_05022025.xlsx'  # or unix / linux / mac path
...
for a in series:
    ...
    if  df["ARCHIVO ORIGEN"].sort_index(inplace=True) == series.sort_index(inplace=True):
        ...
        print(name)
        temp_df.to_excel(r'G:\2.DELEGADAS\UNCOPI\RESPUESTAS RUNTt\Información respuesta\SOLRUNT176\\'+ name +'_RUNT.xlsx' , index=False)
